...
export function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Hero Section */}
      <section ref={heroRef} className="min-h-screen pt-16 items-center transition-all duration-1000 border-bl-[200px]"
        style={{
      ...
      {/* Newsletter Section */}
      <section className="py-12 bg-gray-50" id='newsletter'>
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
