...
import p2 from '../../img/village2.jpg'
import p3 from '../../img/R.jpeg'
import p4 from '../../img/village3.jpg'
import photoagri from '../../img/village5.jpg';
        ...
        <div className=''>
          ...
          >
            <div className='md:px-8'>
              <img src={p4} alt="village" className='w-full mr-[-100px]' />
            </div>
          </motion.div>
          <motion.div
          ...
          >
            <div className='md:mx-8 overflow-x-auto py-4'>
              <div className='flex space-x-4'>
                <img src={p1} alt="village" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
                <img src={p2} alt="village" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
                <img src={p3} alt="village" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
              </div>
            </div>
          </motion.div>
        </div>
