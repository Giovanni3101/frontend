...
import p1 from '../../img/REB3.jpg';
import p2 from '../../img/reb.jpg'
import p3 from '../../img/reb2.jpg'
import p4 from '../../img/REB3.jpg'
import photoagri from '../../img/istockphoto-1500695136-170667a.webp';
import entre from "../../img/PHOTO8.jpg"

export function Ecologie() {
  const projects = [
    {
        ...
        <div className=''>
          ...
          >
            <div className='md:px-8'>
              <img src={p4} alt="reboisemebt" className='w-full mr-[-100px]' />
            </div>
          </motion.div>
          <motion.div
          ...
          >
            <div className='md:mx-8 overflow-x-auto py-4'>
              <div className='flex space-x-4'>
                <img src={p1} alt="reboisement" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
                <img src={p2} alt="reboisement" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
                <img src={p3} alt="reboisement" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="pb-12 pt-12 md:mt-[-80px]">
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <Comments projectId="reboisement"/>
          </div>
        </motion.div>
      </section>
    </div>
