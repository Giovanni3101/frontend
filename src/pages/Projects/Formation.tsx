...
import p1 from '../../img/PHOTO12.jpg';
import p2 from '../../img/fizkes_black-millennial-boss-leading-corporate-team-during-briefing-in-picture-id1139630453.jpg';
import p3 from '../../img/061475162988-web-tete-3dm0ek4nrtcistznyl0mps.jpeg';
import p4 from '../../img/PHOTO8.jpg';
...
export function Formation() {
  ...
  return (
    <div className="pt-20 mt-10 form">
      <div className="">
        <div className="md:grid md:grid-cols-2">
          <div className="">
            ...
            >
              <div className="md:mx-4 overflow-x-auto py-4">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <p className="mt-14">
                    ...
                    ambitieux près pour le changement positif et intégral de
                    toute la communauté de congolaise et surtout de la
