...
import p2 from '../../img/agriculture-pictures-w6giwx3xmfvel0sg.jpg';
import p3 from '../../img/Guyana-Agriculture-Market.png';
import p4 from '../../img/PHOTO5.jpg';
            ...
            <div className="md:mx-8 overflow-x-auto py-4">
              <div className="flex space-x-4">
                <img
                  src={p1}
                  alt="agriculture"
                  className="md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center shadow-md"
                />
                <img
                  src={p2}
                  alt="agriculture"
