          ...
          >
            <div className='md:mx-8 overflow-x-auto py-4'>
              <div className='flex space-x-4'>
                <img src={p1} alt="agriculture" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
                <img src={p2} alt="agriculture" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
                <img src={p3} alt="agriculture" className='md:min-w-48 md:min-h-48 min-w-[80%] h-48 text-white flex items-center justify-center' />
              </div>
            </div>
          </motion.div>
        </div>
